...
const ConsentToTelehealth = () => {
    return (
        <section className='bg-white pt-8 pb-14'>
            <Wrapper>
                <h1 className='font-bold text-3xl sm:text-4xl md:text-6xl mb-5'>Consent To Telehealth</h1>
                <p className='text-sm md:text-base mt-4'>
                    By agreeing to this Consent to Telehealth, you are providing your consent to receive healthcare services through telehealth technology. You acknowledge that you are electronically signing this consent and have reviewed, understood, and accepted the risks and benefits associated with telehealth services as described below, and you wish to receive such services.
                </p>
                <p className='text-sm md:text-base mt-4'>For clarity, when we use the terms “LIGHT PATH USA LLC”, “we”, “us”, or “our”, we are referring to LIGHT PATH USA LLC, while the terms “you” and “yours” refer to the person using the Service. Any capitalized terms mentioned in this Consent to Telehealth and not explicitly defined herein shall have the meanings set forth in the Terms and Conditions.</p>

                <h3 className='text-2xl font-bold mt-7 mb-3'>Telehealth</h3>
                <p className='text-sm md:text-base'>Telehealth involves providing healthcare services using electronic communication, telecommunications, information technology, or other comparable methods to connect a healthcare professional and a patient who are not physically in the same location. Telehealth allows you to access healthcare services from your provider at various locations, including your own home.</p>
                ...
                <p className='text-sm md:text-base mt-4'>
                    <span className='font-bold text-xl text-heading'>Convenience:</span> Telehealth services provide patients with easy access to medical care and treatment, eliminating the need for physical visits to clinics or hospitals to see healthcare providers.
                </p>

                <p className='text-sm md:text-base mt-4'>
                    <span className='font-bold text-xl text-heading'>Efficiency:</span> Interactions with healthcare providers are easier to manage and more efficient with telehealth services.
                </p>

                <p className='text-sm md:text-base mt-4'>
                    <span className='font-bold text-xl text-heading'>Safety:</span> Telehealth eliminates the risk of exposure to illnesses by avoiding contact with other sick individuals in clinics or hospitals.
                    <br /><br />
                    Telehealth is a mode of medical care delivery that offers several advantages, but it also comes with some disadvantages, which include:
                </p>

                <p className='text-sm md:text-base mt-4'>
                    <span className='font-bold text-xl text-heading'>Limited familiarity:</span> Patients may encounter difficulties in communicating and providing comprehensive medical information to their healthcare providers because they are not in a traditional healthcare setting.
                </p>

                <p className='text-sm md:text-base mt-4'>
                    <span className='font-bold text-xl text-heading'>Diagnosis and treatment limitations:</span> Healthcare providers may be unable to diagnose or treat certain medical conditions due to the inability to conduct physical tests and examinations remotely.
                </p>

                <p className='text-sm md:text-base mt-4'>
                    <span className='font-bold text-xl text-heading'>Missed signs and symptoms:</span> Remote assessments may result in missed signs and symptoms that require emergency medical attention or further testing.
                </p>

                <p className='text-sm md:text-base mt-4'>
                    <span className='font-bold text-xl text-heading'>Technological failures:</span> Tele-visits disruptions or delays in evaluation and treatment may occur due to technological failures.
                </p>

                <p className='text-sm md:text-base mt-4'>
                    <span className='font-bold text-xl text-heading'>Privacy and security concerns:</span> The electronic transmission of medical data may result in issues such as unauthorized access, loss of information, or diagnostic images or specimens distortion. Confidential information may be overheard if patients are not in a private location during their tele-visit.
                </p>
                ...
                <p className='text-sm md:text-base mt-4'>
                    It is vital for patients to recognize the potential advantages and drawbacks of telehealth and acknowledge that there are no guarantees that their condition will improve. In some cases, it may even worsen. Patients should also understand that the LIGHT PATH USA LLC is not liable for any loss of information due to technological failures.
                </p>
                ...
                <p className='text-sm md:text-base mt-4'>
                    You have read and comprehended the Consent to Telehealth, which outlines the potential advantages and disadvantages of receiving medical care and treatment through telehealth services. <br /><br />
                    You understand that telehealth services may have advantages and drawbacks, and that LIGHT PATH USA LLC cannot be held responsible for any loss of information caused by technical malfunctions.<br /><br />
                    ...
                    You also authorize your healthcare provider to share information about the telehealth examination with LIGHT PATH USA LLC and its related entities.<br /><br />
                    It is crucial to understand that your healthcare information may be disclosed in specific situations. Examples include complying with a legal court order for medical records, reporting suspected abuse, neglect, or domestic violence, or preventing a serious health or safety threat.
                ...
                <p className='text-sm md:text-base'>In order for LIGHT PATH USA LLC and its healthcare providers to contact me about my Personal Data, appointments, or other matters related to my telehealth sessions, I hereby provide my consent to communicate through call, email, or text message (including SMS and/or MMS), using the contact information I have provided. I am aware that communication may be made through an auto-dialer or prerecorded or synthetic voice, even if my phone number is listed on a do-not-call registry, and that regular phone carrier charges may apply. This Informed Consent for Asynchronous Telehealth applies throughout my treatment with LIGHT PATH USA LLC.</p>
            </Wrapper>
        </section>
    )
}
