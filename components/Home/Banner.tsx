        ...
        <section className='sm:min-h-[calc(50vh)] lg:min-h-[780px] bg-lightgray relative z-0 pb-8 lg:pb-0 pt-9 lg:pt-0'>
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-full">
                <div className='grid grid-cols-1 lg:grid-cols-2 items-center lg:min-h-[780px]'>
                    ...
                    <div>
                        <Image src="/images/products.png" alt="products" width="750" height="750" className='ml-auto mr-auto lg:mr-0' />
                        <div className='lg:hidden text-center'>
                            <a href='#' className='theme-btn !bg-white !text-green !border-white !text-sm !min-w-[285px] !h-11'>START YOUR TREATMENT TODAY</a>
                        </div>
                    </div>
                </div>
            </div>
